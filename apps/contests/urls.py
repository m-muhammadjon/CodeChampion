...
urlpatterns = [
    ...
    path("contests/<int:pk>/<str:symbol>/", views.contest_problem_detail, name="contest_problem_detail"),
    path("contests/<int:pk>/<str:symbol>/submit", views.submit_contest_problem, name="submit_contest_problem"),
]
